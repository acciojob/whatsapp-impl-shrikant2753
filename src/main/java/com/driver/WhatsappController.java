...
public class WhatsappController {
    ...
    public String createUser(@RequestParam("name") String name, @RequestParam("mob") String mobile) throws Exception {
    ...
    public Group createGroup(@RequestParam("groupUser") List<User> users){
    ...
    public int createMessage(@RequestParam("msgContent") String content){
